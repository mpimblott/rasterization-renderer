...
int main() {
    ...
    std::shared_ptr<Mesh> mesh = loader.load("/home/matt/projects/rasterization-renderer/meshes/shuttle.obj");
    std::cerr << (*mesh) << std::endl;
    cam.set_look_at(Point3h(-3, -8, 8), Vec3h(0, 1, 0), Point3h(0, 0, 0));
