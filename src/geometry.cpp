...
const size_t Mesh::get_n_faces() const { return (*vertices).size() / 3; }

const size_t &Mesh::get_total_non_unique_vertices() const { return totalNonUniqueVertices; }
...
Mesh::Mesh(size_t totalNonUniqueVertices, unique_ptr<std::vector<size_t>> vertexOrderingIndices,
